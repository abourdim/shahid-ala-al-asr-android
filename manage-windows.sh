#!/usr/bin/env bash
# ============================================================================
#  Shahid ala al-Asr Android · management console · WINDOWS
...
SRC_BOOK_DIR="${SRC_BOOK_DIR:-$HOME/koutoub/46-shahid-ala-al-asr}"
...
AVD_NAME="${AVD_NAME:-shahid_ala_al_asr_test}"
...
cmd_test() {
  ...
  local out="/tmp/shahid-ala-al-asr-$(date +%Y%m%d-%H%M%S).png"
...
show_menu() {
  ...
  cat <<EOF
${BOLD}${MAGENTA}+==================================================================+
|   Shahid ala al-Asr Android . management console (Windows $SHELL_ENV)${RESET}${BOLD}${MAGENTA}
